'''
Problem  - For a given text, get if multiple patterns exist.  Provide index of each occurance

Soln: Create trie of all patterns, then can easily search through text and check each pattern at once

---this soln can be used for problem 3 so may have to speed it up a bit
'''
# python3
import sys
